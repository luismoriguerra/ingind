  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="form_proveedores_modal" name="form_proveedores_modal" action="" method="post">
          
          <div class="form-group">
            <label class="control-label">Ruc:</label>
            <input type="text" class="form-control" placeholder="Ingrese Ruc" name="txt_ruc" id="txt_ruc">
          </div>
