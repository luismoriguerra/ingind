...
@section('includes')
    ...
    @include( 'admin.contabilidad.js.gastos_ajax' )
    @include( 'admin.contabilidad.js.gastos' )
@stop
    ...
    <!-- Content Header (Page header) -->
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Mantenimiento de Gastos</li>
            </ol>
        </section>
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        ...
                        -->
                            <a style="display:none" id="BtnEditar" data-toggle="modal" data-target="#<?=name_controllerG?>Modal" data-titulo="Editar"></a>
                        </div><!-- /.box-body -->
                        </form>
                    </div><!-- /.box -->
                    <!-- Finaliza contenido -->
