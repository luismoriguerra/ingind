...
@section('includes')
    ...
    @include( 'admin.reporte.js.inicioarea' )
@stop
...
@section('contenido')
    ...
    <section class="content-header">
        <h1>
            Vista de estados de las cartas de inicio por área
            <small> </small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Admin</a></li>
            <li><a href="#">Reporte</a></li>
            <li class="active">Vista de estados de las cartas de inicio por área</li>
        </ol>
    </section>
