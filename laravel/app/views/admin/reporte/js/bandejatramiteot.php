...
buscar=function(){
    $("#btn_close").click();
    var fil=[];
    if( $("#slct_tipo_visualizacion").val() ){
        fil=$("#slct_tipo_visualizacion").val();
    }

    if( $("#txt_orden_trabajo").val()!="" ){
     var datos={ tramite:$("#txt_orden_trabajo").val(),filtro:fil };
    $("#tabla_ruta_detalle").css("display","");
    Bandeja.Mostrar(datos);
    }
    else{
        alert("Ingrese Nro Orden de Trabajo y busque nuevamente");
    }
}
