...
@section('includes')
    ...
    @include( 'admin.reporte.js.acciones_ajax' )
    @include( 'admin.reporte.js.acciones' )
@stop
...
@section('contenido')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Vista de avances realizados</li>
        </ol>
    </section>
                        ...
                        <div class="box-body table-responsive">
                            <table id="t_reporte" class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th>Area</th>
                                        <th>N° Acciones (Acciones actuales) / (Acciones anteriores)</th>
                                        <th>Fecha del último cambio</th>
                                        <th>Area dueña del proceso</th>
                                        <th>Nombre del Proceso</th>
                                        <th>Estado del Proceso</th>
                                        <th>Paso de la Ruta</th>
                                    </tr>
                                </thead>
                                <tbody id="tb_reporte">
                                </tbody>
