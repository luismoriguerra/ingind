...
@section('includes')
    ...
    @include( 'admin.reporte.js.rutaprocesos' )
@stop
                    ...
                    <div class="row form-group" >
                        <div class="col-sm-12">
                            <div class="col-sm-4">
                                ...
                                <select class="form-control" name="slct_area_idr" id="slct_area_idr" multiple>
                                </select>
                            </div>
                            <div class="col-sm-3">
                                <label class="control-label">Rango de Fechas Creación:</label>
