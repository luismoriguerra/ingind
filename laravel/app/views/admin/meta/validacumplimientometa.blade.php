...
@section('includes')
    ...
    @include( 'admin.meta.js.validacumplimientometa_ajax' )
    @include( 'admin.meta.js.validacumplimientometa' )
@stop
...
@section('contenido')
    ...
    <section class="content-header">
        <h1>
            VALIDAR CUMPLIMIENTO DE LA GESTION POR RESULTADO
            <small> </small>
        </h1>
        <ol class="breadcrumb">
...
@stop
@section('formulario')
     @include( 'admin.meta.form.validacumplimientometa' )
@stop