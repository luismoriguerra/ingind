...
var Tiempos = {
    AgregarEditarTiempo:function(AE){
        var datos = $("#form_tiempos_modal").serialize().split("txt_").join("").split("slct_").join("");
        var accion = (AE==1) ? "tiempo/editar" : "tiempo/crear";
   ...
   CambiarEstadoTiempos: function(id, AD){
        $("#form_tiempos_modal").append("<input type='hidden' value='"+id+"' name='id'>");
        $("#form_tiempos_modal").append("<input type='hidden' value='"+AD+"' name='estado'>");
        var datos = $("#form_tiempos_modal").serialize().split("txt_").join("").split("slct_").join("");
        $.ajax({
