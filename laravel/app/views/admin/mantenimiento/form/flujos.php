      ...
      <div class="modal-body">
        <form id="form_flujos_modal" name="form_flujos_modal" action="" method="post">
          <div class="form-group">
            <label class="control-label">Nombre del Flujo:</label>
            <input type="text" class="form-control" placeholder="Ingrese Nombre" name="txt_nombre" id="txt_nombre">
          </div>
          <div class="form-group">
              <label class="control-label">Area del Flujo:</label>
              <select class="form-control" name="slct_area_id" id="slct_area_id">
              <option value="">.::Seleccione::.</option>
              </select>
          </div>
          <div class="form-group">
              <label class="control-label">Categoría del Flujo:</label>
              <select class="form-control" name="slct_categoria_id" id="slct_categoria_id">
              <option value="">.::Seleccione::.</option>
              </select>
          </div>
          <div class="form-group">
              <label class="control-label">Tipo del Flujo:</label>
