<!-- /.modal -->
<div class="modal fade" id="subtipoModal" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <textarea type="text" class="form-control" placeholder="Ingrese Color" name="txt_color" id="txt_color"></textarea>
          </div>
