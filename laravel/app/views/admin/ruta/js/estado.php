...
PendienteRutaFlujo=function(id){
    if( confirm("Esta apunto de pasar a pendiente; Si acepta no podra regresar al estado anterior.") ){
        Ruta.ActualizarRutaFlujo(id,2,HTMLCargarRuta);
    }
}

AnularRutaFlujo=function(id){
    if( confirm("Esta apunto de anular la ruta del proceso; Si acepta, eliminará la ruta seleccionada.") ){
        Ruta.ActualizarRutaFlujo(id,0,HTMLCargarRuta);
    }
}
