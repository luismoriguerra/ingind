                ...
                <div class="row">
                  <div class="col-md-12">
                      <div class="col-md-4 form-group">
                          ...
                          <input class="form-control" type="text" name="txt_codtramite" id="txt_codtramite" value="">
                      </div>
                      <div class="col-md-4 form-group">
                           <label>Fecha Ingreso:</label>
                           <input class="form-control" type="text" name="txt_fechaingreso" id="txt_fechaingreso" value="">
                      </div>
                      <div class="col-md-4 form-group">
                ...
                <div class="row">
                  <div class="col-md-12">
                      <div class="col-md-4 form-group">
                          ...
                          <input class="form-control" type="text" name="txt_nombtramite" id="txt_nombtramite" value="">
                      </div>
                      <div class="col-md-4 form-group">
                           <label>#Num Documento:</label>
                           <input class="form-control" type="text" name="txt_numdocA" id="txt_numdocA" value="">
                      </div>
                      <div class="col-md-4 form-group">
                           <label>#Folio:</label>
