...
@section('includes')
    ...
    @include( 'admin.contratacion.js.contratacion_ajax' )
    @include( 'admin.contratacion.js.contratacion' )
@stop
                    ...
                    <div class="box">
                        ...
                        <div class="box-body table-responsive">
                            <table id="t_contrataciones" class="table table-bordered table-hover">
                                <thead>
                                <tr><th colspan="12" style="text-align:center;background-color:#A7C0DC;"><h2>Contrataciones</h2></th></tr>
                                <tr></tr>
                                </thead>
                                <tbody>
                                </tbody>
...
@section('formulario')
     @include( 'admin.contratacion.form.contratacion' )
     @include( 'admin.contratacion.form.detalle_contratacion' )
@stop
