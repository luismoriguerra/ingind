      ...
      <div class="modal-body">
        <form id="form_contrataciones_modal" name="form_contrataciones_modal" action="" method="post">
          ...
          <div class="form-group">
            ...
            <textarea type="text" class="form-control" placeholder="Ingrese Objeto" name="txt_objeto" id="txt_objeto"></textarea>
          </div>
          <div class="form-group">
            <label class="control-label">Justificación:</label>
            <textarea type="text" class="form-control" placeholder="Ingrese Justificación" name="txt_justificacion" id="txt_justificacion"></textarea>
          </div>
          <div class="form-group">
