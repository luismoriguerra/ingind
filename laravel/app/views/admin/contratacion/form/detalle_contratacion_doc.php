      ...
      <div class="modal-body">
        <form id="form_detalle_contrataciones_modal" name="form_detalle_contrataciones_modal" action="" method="post">
          ...
          <div class="form-group">
            ...
            <textarea type="text" class="form-control" placeholder="Ingrese Texto" name="txt_texto" id="txt_texto" disabled=""></textarea>
          </div>
            <div class="col-sm-4">
          <div class="form-group">
            <label class="control-label">Monto:</label>
            <input type="text" class="form-control" placeholder="Ingrese Monto" name="txt_monto" id="txt_monto" disabled="">
          </div>
                </div>
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="slct_tipo" id="slct_tipo" disabled="">
