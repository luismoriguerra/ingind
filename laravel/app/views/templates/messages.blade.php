    ...
    <div id="message" class="message row" style="padding: 5px 15px 5px 20px">
        <div class="media msg ">
            ...
            <div class="media-body">
                <span class="media-heading" fecha="message.created_at" style="font-size: 11px;font-weight: bold;">@{{ message.user.nombre + " " + message.user.paterno + " "  + message.user.materno}}</span>
                <br>
