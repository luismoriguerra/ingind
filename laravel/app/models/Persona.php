...
class Persona extends Base implements UserInterface, RemindableInterface
{
    ...
    {     
        $sSql = '';
        $sSql.= "SELECT rd.id norden,rd.actividad,rd.fecha_inicio,rd.dtiempo_final,rd.ot_tiempo_transcurrido,SEC_TO_TIME(rd.ot_tiempo_transcurrido * 60) formato FROM  tablas_relacion tr 
