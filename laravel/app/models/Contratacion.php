...
class Contratacion extends Base
{
    ...
    {
        $sSql=" SELECT c.id, c.titulo,c.monto_total,c.objeto,c.justificacion,c.actividades,c.fecha_conformidad,c.fecha_inicio,c.fecha_fin,c.fecha_aviso,c.programacion_aviso,c.nro_doc,c.area_id, c.estado, a.nombre as area
                FROM contratacion c
                LEFT JOIN areas a ON a.id=c.area_id 
                WHERE 1=1 ";
        $sSql.= $array['where'].
