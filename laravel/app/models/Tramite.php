...
class Tramite extends Eloquent {
	...
	public static function getAllTramites(){
		$sql ="select t.id codigo,ct.nombre_clasificador_tramite tramite,t.fecha_tramite fecha_ingreso,CONCAT_WS(' ',p.nombre,p.paterno,p.materno) persona,t.estado estado,t.observacion observacion,'' area,t.documento numdoc from tramites t 
	...
	public static function getTramiteById(){
		$sql = "select t.id tramiteid,'' as area,t.persona_id personaid,t.tipo_documento_id tdocid,t.clasificador_tramite_id ctid,t.tipo_solicitante_id tsid,t.area_id areaid,t.fecha_tramite fregistro,p.dni dniU,p.nombre nombusuario,p.paterno apepusuario,p.materno apemusuario,
